...
import { getDate, getRating, getRuntimeOrEpisodes } from '../utils/utilsFn';
...
export default function Details({ section, details, isError }: IInfoProps) {
